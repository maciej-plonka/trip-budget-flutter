...
void main(){
  group("Trip", () {
    test("should throw error when trying to create trip with null name",(){
      final int invalidId = null;
      final String name = "Valid name";
      final DateTime startDate = DateTime.now();
      final DateTime endDate = startDate.add(Duration(days:1));
      expect(() => TripModel(id: invalidId, name : name, startDate : startDate, endDate : endDate), throwsAssertionError);
    });
    ...
    test("should throw error when trying to create trip with null name",(){
      ...
      final DateTime startDate = DateTime.now();
      final DateTime endDate = startDate.add(Duration(days:1));
      expect(() => TripModel(id: 1, name : nullName, startDate : startDate, endDate : endDate), throwsAssertionError);
    });
    ...
    test("should throw error when trying to create trip with null startDate",(){
      ...
      expect(() => TripModel(id: 1, name : validName, startDate : nullStartDate, endDate : endDate), throwsAssertionError);
    });
    ...
    test("should throw error when trying to create trip with null endDate",(){
      ...
      expect(() => TripModel(id: 1, name : validName, startDate : startDate, endDate : nullEndDate), throwsAssertionError);
    });
